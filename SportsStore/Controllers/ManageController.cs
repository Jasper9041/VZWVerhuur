    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Naam = c.Naam,
                Voornaam = c.Voornaam,
                VerenigingOfBedrijf = c.VerenigingBedrijf
        ...
        {
            Customer c = CustomerRepository.FindBy(User.Identity.GetUserName());
            return View(new ChangeViewModel(c) {Email = c.Email,Naam = c.Naam,Voornaam = c.Voornaam,VerenigingOfBedrijf = c.VerenigingBedrijf});
        }
